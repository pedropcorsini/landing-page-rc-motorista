...
export function Hero() {
  return (
    <section id="top" className="relative overflow-hidden px-4 pb-20 pt-32 sm:pt-36 lg:pb-28">
      <div className="absolute inset-0 -z-10 bg-[radial-gradient(circle_at_top_left,rgba(14,165,233,0.22),transparent_34%),radial-gradient(circle_at_80%_10%,rgba(37,211,102,0.12),transparent_26%)]" />
      <div className="mx-auto grid max-w-6xl items-center gap-10 lg:grid-cols-[1.05fr_0.95fr]">
        <div>
          <p className="mb-5 inline-flex rounded-full border border-brand/30 bg-brand/10 px-4 py-2 text-sm font-semibold text-sky-200">
          ...
          <p className="mt-6 max-w-2xl text-lg leading-8 text-slate-300">{site.subheadline}</p>
          ...
          <div className="rounded-[1.5rem] border border-white/10 bg-surface p-6 sm:p-8">
            ...
            <div className="space-y-5 py-6">
              <div className="flex gap-4">
                <MapPin aria-hidden="true" className="mt-1 h-5 w-5 flex-none text-sky-300" />
                <div>
