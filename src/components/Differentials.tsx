...
export function Differentials() {
  return (
    <section id="diferenciais" className="px-4 py-20">
      <div className="mx-auto grid max-w-6xl gap-5 lg:grid-cols-[1fr_0.82fr] lg:items-stretch">
        <div className="rounded-[2rem] border border-white/10 bg-surface p-8 sm:p-10 lg:h-full">
          <div>
        ...
        <div className="grid gap-2.5 sm:grid-cols-2 lg:h-full lg:max-w-[520px] lg:grid-rows-2 lg:self-stretch">
