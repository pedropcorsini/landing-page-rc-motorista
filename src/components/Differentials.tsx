import { CheckCircle2, Clock3, MessageSquareText, ShieldCheck, Sparkles, UserRoundCheck } from 'lucide-react';
import { site } from '../data/site';

const icons = [Clock3, ShieldCheck, UserRoundCheck, Sparkles, MessageSquareText];

export function Differentials() {
  return (
    <section id="diferenciais" className="px-4 py-20">
      <div className="mx-auto grid max-w-6xl gap-8 lg:grid-cols-[0.9fr_1.1fr]">
        <div className="rounded-[2rem] border border-white/10 bg-surface p-8 sm:p-10">
